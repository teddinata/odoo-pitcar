        ...
        try:
            ...
            design_kpi_template = [
                ...
                },
                {
                    ...
                    'weight': 25,
                    'target': 90,
                    'measurement': 'Persentase konten dengan revisi maksimal 5x',
                    'include_in_calculation': True
                },
                {
                    'no': 4,
            ...
            if 'Desain Grafis' in job_title or 'Graphic Design' in job_title:
            ...
            performance_status = 'Achieved' if total_score >= avg_target else 'Below Target'

            # Format the period for response
            ...
            _logger.info(f"KPI Response: {response}")

            return response

        except Exception as e:
            _logger.error(f"Error in get_marketing_kpi: {str(e)}", exc_info=True)
